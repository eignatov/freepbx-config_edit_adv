...
//////////////////////////////////////////////////////////
    function OC_HTML_doHtmlHeader()
    {
        ...
        ?>
            ...
            <body><img src="<?PHP echo  $this->_OC_HTML_images_dir ?>sspacer.gif" alt="spacer" width="10" height="17">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="menuTop">
                <tr align="center">
                <td width = "125"><img src="<?PHP echo  $this->_OC_HTML_images_dir ?>sspacer.gif" width="125" height="22" alt="spacer"></td><?PHP $this->OC_HTML_doHeaderBar() ?><td></td>
                </tr>
                <tr>
                <td></td>
                <td><img src="<?PHP echo $this->_OC_HTML_images_dir ?>sspacer.gif" alt="spacer" width="50" height="1"></td>
                <td><img src="<?PHP echo $this->_OC_HTML_images_dir ?>sspacer.gif" alt="spacer" width="50" height="1"></td>
                <td><img src="<?PHP echo $this->_OC_HTML_images_dir ?>sspacer.gif" alt="spacer" width="50" height="1"></td>
                <td><img src="<?PHP echo $this->_OC_HTML_images_dir ?>sspacer.gif" alt="spacer" width="50" height="1"></td>
                <td><img src="<?PHP echo $this->_OC_HTML_images_dir ?>sspacer.gif" alt="spacer" width="50" height="1"></td>
                ...
                <td><img src="<?PHP echo $this->_OC_HTML_images_dir ?>sspacer.gif" alt="spacer" width="80" height="1"></td>
                </tr>
            </table></td>
            </tr>
            <tr>
...
//////////////////////////////////////////////////////////
    ...
    ?>
        <!-- page footer -->
            ...
            <tr>
            <td><img src="<?PHP echo $this->_OC_HTML_images_dir ?>sspacer.gif" alt="spacer" width="125" height="1"></td>
            <td></td>
            <td><img src="<?PHP echo $this->_OC_HTML_images_dir ?>sspacer.gif" alt="spacer" width="540" height="1"></td>
            <?PHP if($this->_OC_HTML_3pane) echo "<td></td><td><img src=\"$this->_OC_HTML_images_dir" . "sspacer.gif\" alt=\"spacer\" width=\"125\" height=\"1\"></td>" ?>
            </tr>
            <tr>
...
//////////////////////////////////////////////////////////
    ...
    {
        ?>
            <form  name="section_form" method="post" action="<?PHP echo "$PHP_SELF?file=$file" ?>">
